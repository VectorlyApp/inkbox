...
class IdentitiesResource:
    ...
    def create(self, *, agent_handle: str) -> AgentIdentity:
        ...
        return AgentIdentity._from_dict(data)

    def list(self) -> list[AgentIdentity]:
        """List all identities for your organisation."""
        data = self._http.get("/")
        return [AgentIdentity._from_dict(i) for i in data]

    def get(self, agent_handle: str) -> AgentIdentityDetail:
        ...
        return AgentIdentityDetail._from_dict(data)
